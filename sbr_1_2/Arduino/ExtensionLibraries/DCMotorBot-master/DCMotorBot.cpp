...
DCMotorBot::DCMotorBot() {
	/* Commenting since there is no use case foe Enable Pins in our scenario */
    //setEnablePins(1, 2);
 ...
 */
void DCMotorBot::balanceForward() {

	/* Balance forward movement if it falls backward */
    digitalWrite(mI1, HIGH);
    digitalWrite(mI2, LOW);
    digitalWrite(mI3, HIGH);
    digitalWrite(mI4, LOW);
 ...
 */
void DCMotorBot::balanceBackward() {

	/* Balance backward movement if it falls forward */
    digitalWrite(mI1, LOW);
    digitalWrite(mI2, HIGH);
    digitalWrite(mI3, LOW);
    digitalWrite(mI4, HIGH);
